...
python main.py driving_gazebo --beta 0.0000001 --gamma 0.0000001 --network_name gaia --architecture ring --model ADTVNet --n_rounds 5000 --bz_train 32 --bz_test 32 --device cpu --log_freq 20 --local_steps 5 --lr 0.0001 --alpha 0.0000002 --min_degree 6 --decay cyclic
